...
public class effectMulanBaoFa : effectBasic
{
	...
	public override void Init ()
	{
		...
		timerForEffect = 10f;//生效时间
		lifeTimerAll = 35f;//总持续时间，也是冷却时间
		theEffectName = "裂天";
		//注意的是，最大生命值每回合都会更新的，这个最大生命值的削弱仅仅限制于本回合(如果削减最大斗气值就太变态了)
		theEffectInformation = "获得" + superBladePercentAdd * 100 + "%的暴击率和"+attackSpeedAdd*100+"%攻击速度，持" +
			"续" + timerForEffect + "秒\n在暴击时造成额外伤害的" + hpDamagePercent * 100 + "%将转化为自身生命\n每一击最多恢复" + DamageUseMax * hpDamagePercent +"生命，冷却时间" + lifeTimerAll + "秒";
